module FSharp.TypeProviders.SDK.FunctionalImplementation
...
type BasicErasingProvider (config : TypeProviderConfig) as this =
    inherit TypeProviderForNamespaces (config, assemblyReplacementMap=[("FSharp.TypeProviders.SDK.Functional.DesignTime", "FSharp.TypeProviders.SDK.Functional.Runtime")], addDefaultProbingLocation=true)
...
type BasicGenerativeProvider (config : TypeProviderConfig) as this =
    inherit TypeProviderForNamespaces (config, assemblyReplacementMap=[("FSharp.TypeProviders.SDK.Functional.DesignTime", "FSharp.TypeProviders.SDK.Functional.Runtime")])

    let ns = "FSharp.TypeProviders.SDK.Functional"
    let asm = Assembly.GetExecutingAssembly()
