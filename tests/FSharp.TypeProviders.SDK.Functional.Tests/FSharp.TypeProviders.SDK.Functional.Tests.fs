module FSharp.TypeProviders.SDK.FunctionalTests
...
type Generative2 = FSharp.TypeProviders.SDK.Functional.GenerativeProvider<2>
type Generative4 = FSharp.TypeProviders.SDK.Functional.GenerativeProvider<4>
